...
const infoList = [
  {
    name: '(ENTM) 💛불뿜는 용💛',
    desc: '👉분위기 메이커 그 자체인 당신! 사람들과 어울리는 것을 즐기고, 또 그것에 적극적으로 참여해요. 일정이 없는 날에도 산책이라도 하러 나갈 만큼 외부 활동을 즐기며, 많은 사람들과 함께하며 사회적, 정서적 유대관계를 맺으면서 즐거움과 에너지를 얻어요. 모두가 함께 즐길 수 있는 오프라인 문화예술 활동을 잘 즐길 수 있을 것 같아요. \n 👉나무보다는 숲을 보는 당신은 상상력이 풍부해서 누가 말을 걸어도 듣지 못할 만큼 혼자 상상의 나래를 자주 펼치곤 해요. 영화를 볼 때에는 영화 속 인물 한 명 한 명에 집중하기보다는 전체적인 흐름을 파악하면서 진행되는 스토리에 관심을 가지며, 공연을 볼 때에도 흘러가는 상황을 바라보며 공연을 편히 감상하기보다는 감정이입을 즐기거나 다음 상황을 상상하기도 해요 \n 👉고전적이고 전통적인 멋을 아는 당신! 당신은 과거를 통해 배울 줄 아는 생각이 깊은 사람이에요. 때때론 어지러운 사회 속에서 혼자만의 사색에 잠기는 것을 좋아합니다. \n 👉뮤직 이즈 마이 라이프! 음악을 들을 때면 다양한 추억이 떠오르는 당신은 오늘도 유튜브에 ~할 때 듣는 노래를 검색해서 들으며 음악으로 힐링하고 있지는 않나요? 음악을 즐길 줄 아는 진정한 뮤지션인 당신에게 음악 관련 행사 참여를 추천할게요!'
  },
  {
    name: '(ENTA)💛춤추는 고양이💛',
